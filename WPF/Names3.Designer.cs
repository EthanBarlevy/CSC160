...
namespace WPF {
    ...
    public partial class Names3 : global::System.Data.DataSet {
        ...
        public partial class NamesDataTable : global::System.Data.TypedTableBase<NamesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NamesRow AddNamesRow(string Name, string Title) {
        ...
        public partial class NamesRow : global::System.Data.DataRow {
            ...
            public string Title {
                get {
                    try {
                        return ((string)(this[this.tableNames.TitleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Title\' in table \'Names\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableNames.TitleColumn] = value;
                }
            }
            ...
            public bool IsTitleNull() {
                return this.IsNull(this.tableNames.TitleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTitleNull() {
                this[this.tableNames.TitleColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class NamesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Names] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND" +
                " [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Title = 1 AND [Titl" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Names] ([Name], [Title]) VALUES (@Name, @Title);\r\nSELECT ID, N" +
                "ame, Title FROM Names WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Names] SET [Name] = @Name, [Title] = @Title WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)));
SELECT ID, Name, Title FROM Names WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-D9TBPNK;Initial Catalog=CSC160;Integrated Security=True;Conne" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Title FROM dbo.Names";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Title) {
        ...
        public virtual int Update(string Name, string Title, int Original_ID, string Original_Name, string Original_Title, int ID) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Title, int Original_ID, string Original_Name, string Original_Title) {
            return this.Update(Name, Title, Original_ID, Original_Name, Original_Title, Original_ID);
        }
    }
